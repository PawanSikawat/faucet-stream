...
independently).
## [1.3.2](https://github.com/PawanSikawat/faucet-stream/compare/faucet-sink-kafka-v1.3.1...faucet-sink-kafka-v1.3.2) - 2026-07-24

### Miscellaneous

- Updated the following local packages: faucet-core, faucet-common-kafka

## [1.3.1](https://github.com/PawanSikawat/faucet-stream/compare/faucet-sink-kafka-v1.3.0...faucet-sink-kafka-v1.3.1) - 2026-07-17
...
## [1.3.0](https://github.com/PawanSikawat/faucet-stream/compare/faucet-sink-kafka-v1.2.1...faucet-sink-kafka-v1.3.0) - 2026-07-10
